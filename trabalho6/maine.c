 ...
 * 
 * 
 *  Teste de lista simples encadeada com capacidade de 10.000
 * 
 **/
...
int main(){
   ...
   for (i = 0; i < 3333; i++){ // inicio do loop gerando 3.333 valores aleatorios e inserindo eles no inicio da lista
    ...
    for (j = 0; j < 3334; j++){ // inicio do loop gerando 3.334valores aleatorios e inserindo eles no fim da lista
     ran =  rand() % 99999;
         insereFim(&lista, ran);
     }
